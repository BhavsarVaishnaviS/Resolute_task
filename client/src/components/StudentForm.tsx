...
// import { encryptStudentPayload, hashEmailForIndex } from '../utils/crypto';
...
//         setLoading(true);
//         try {
//             // Level-1 encryption: encrypt all student data before sending to server
//             const payload = { ...form };
//             if (isEdit && !payload.password) delete (payload as any).password;

//             const encryptedPayload = encryptStudentPayload(payload);
//             const emailHash = hashEmailForIndex(form.email);

//             if (isEdit && editData) {
//                 await api.put(`/student/${editData.id}`, { encryptedPayload, emailHash });
//             } else {
//                 await api.post('/register', { encryptedPayload, emailHash });
//             }
...
//                         🔐 Data will be AES encrypted (Level 1) before transmission. Backend applies Level 2 encryption before storage.
//                     </div>
